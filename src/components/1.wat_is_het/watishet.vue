<template>
  <!--  <div id="wat-is-het" data-spy="scroll" data-target=".navbar" data-offset="50">-->
  <div id="wat-is-het">
...
<!--      BREAK 1-->
      ...
      <div class="row py-xl-5 py-lg-5 py-md-4">
        ...
        <div
          ...
          <div id="summary_integration" class="ml-xl-0 ml-lg-0 ml-md-0 ml-sm-3 ml-3"
               v-for="item in WatIsHet.whatsappIntegratie.checks" :key="item">
            <div class="d-flex">
              <i class="bi bi-check-lg mr-2"></i>
              <p class="mt-2 pt-1">{{ item }}</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <!--        <div class="row py-5">-->
    <!--          <div class="col">-->
    <!--            <p>Lorem ipsum dolor sit amet, consectetur adipisicing, elit. A animi asperiores at aut cum cupiditate-->
    <!--              deserunt-->
    <!--              doloremque doloribus est fugiat, ipsa ipsam iste iure minus modi mollitia nihil perferendis placeat-->
    <!--              quas-->
    <!--              quo-->
    <!--              recusandae rerum sed sint sunt tempora. Aliquid dolorem enim error eveniet iure iusto minima odit-->
    <!--              provident?-->
    <!--              A, ad aliquam asperiores assumenda atque cupiditate dolorum fugit impedit iste laborum, modi nam-->
    <!--              perferendis</p>-->
    <!--          </div>-->
    <!--        </div>-->
    <!--      </div>-->
...
<!--    MOGELIJKHEDEN-->
        <div class="container-xl" id="posibilities">
          <div class="row">
            <div class="col text-center">
              <h2 class="my-xl-4 my-lg-3 my-md-4 my-sm-4 my-4 mb-md-5 pb-md-5 text-center d-xl-block d-lg-none d-md-block d-sm-block d-block">
                {{ WatIsHet.title_posibs }}</h2>
              <h2 class="d-xl-none d-lg-block d-md-none d-sm-none d-none my-xl-4 my-lg-3 my-md-4 my-sm-4 my-4 mb-md-5 pb-md-5 text-center"
                  v-html="WatIsHet.title_posibs992.replace(/(\n)/g, '<br />')"></h2>
            </div>
          </div>
          <div class="row">
            <div
                class="offset-xl-0 col-xl-5 offset-lg-0 col-lg-5 offset-md-1 col-md-10 offset-sm-2 col-sm-8 offset-2 col-8 my-5">
              <h1>IMAGE</h1>
            </div>
            <div class="offset-xl-0 col-xl-7 offset-lg-0 col-lg-7 offset-md-1 col-md-10 offset-sm-0 col-sm-12 offset-0 col-12  text-center">
              <div class="row my-3">
                <div class="offset-xl-0 col-xl-6 offset-lg-0 col-lg-6 offset-md-0 col-md-6 offset-sm-1 col-sm-10 offset-1 col-10 mt-xl-0 mt-3" v-for="(item, index) in WatIsHet.mogelijkheden" :key="index.id">
                  <div class="social_icon">
                    <i :class="item.icon"></i>
                    <svg width="100" height="100" class="social_icon_svg">
                      <circle cx="50" cy="50" r="45" fill="#DC3545"></circle>
                    </svg>
                  </div>
                  <h3 class="my-xl-3 my-lg-3 my-md-3 my-sm-3 my-3">{{ item.title }}</h3>
                  <p style="line-height: 1.5; font-weight: 300">{{ item.description }}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col">
            ...
            <div class="d-flex advantage_svg" v-for="(item, index) in WatIsHet.voordelen" :key="index">
              ...
              <svg width="100" height="100" class="mr-xl-2 mr-lg-2 mr-md-5 mr-sm-5">
                <circle cx="45" cy="45" r="35" fill="#dc3545" stroke="#ffffff" stroke-width="7"></circle>
              </svg>
...
export default {
  ...
  // computed: {
  //   info() {
  //     console.log(infoOverWhatsapp);
  //     JSON.parse(infoOverWhatsapp);
  //     console.log(infoOverWhatsapp);
  //     return "test";
  //   }
  // },
  ...
  methods: {
    // async loadJSONData() {
    //   try {
    //     const response = await fetch('public/JSON/WatIsHet.json');
    //     const jsonData = await response.json();
    //     console.log(jsonData);
    //     // this.verbindWhatsApp = jsonData.verbindWhatsApp;
    //     // this.whatsAppIntegratie = jsonData.whatsAppIntegratie;
    //   } catch (error) {
    //     console.error('Fout bij het laden van JSON-gegevens:', error);
    //   }
    // }
  },
  mounted() {
    // console.log(this.WatIsHet);
    // this.loadJSONData(); // roep de methode aan om de JSON-gegevens te laden wanneer het component wordt gemonteerd
    // this.voordelen = infoOverWhatsapp.WatIsHet.voordelen;
...
#wat-is-het {
  ...
  #gradient {
    background: linear-gradient(to right, $gradientLightRed, $colorSecondary);
